    ...
    if (!empty($query)) {
        ...
        while ($value = $query->fetch_array()) {
            ...
            $nestedData['hrgjual_barang']   = '<table><tr>
                                                <td><b>(U)</b> </td><td>'.format_rupiah($value['hrgjual_barang']).'</td>
                                            </tr>
                                            <tr>
                                                <td><b>(R)</b> </td><td>'.format_rupiah($value['hrgjual_barang1']).'</td>
                                            </tr>
                                            <tr>
                                                <td><b>(K)</b> </td><td>'.format_rupiah($value['hrgjual_barang2']).'</td>
                                            </tr></table>';
