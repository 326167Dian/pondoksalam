    					...
    					$aksi_trkasir = "masuk/modul/mod_trkasir/aksi_trkasir.php";
							...
							$grandnya = format_rupiah($ttlprice['grandnya']);
							   ...
							   ORDER BY trkasir_detail.id_dtrkasir ASC");
                                ...
                                if($tipe = ($r['tipe']==1)){ $tipe = '<span class="btn btn-xs btn-primary">Umum</span>';}
                                else if($tipe = ($r['tipe']==2)){ $tipe = '<span class="btn btn-xs btn-success">Resep</span>';}
                                else if($tipe = ($r['tipe']==3)){ $tipe = '<span class="btn btn-xs btn-info">Khusus</span>';}
                                else if($tipe = ($r['tipe']==4)){ $tipe = '<span class="btn btn-xs btn-warning">Khusus</span>';}
